  ...
  return (
    <>
      <style>{`
        ...
        .login-panel { animation: lp-slide-in 0.4s var(--ease-out) both; }
        ...
        .login-tab.active { color: var(--kuro); border-bottom-color: var(--aka); }
        ...
        .google-btn:hover { border-color: var(--neutral-500); box-shadow: 0 2px 8px rgba(0,0,0,0.06); }
        ...
        <div className="login-form-side" style={{
          ...
          <div className="login-panel" style={{ width: '100%', maxWidth: '400px' }}>
            ...
            {showEnrollForm ? (
              ...
              <>
                {/* ── Tabs ── */}
                <div style={{ display: 'flex', borderBottom: '1.5px solid var(--neutral-200)', marginBottom: '28px' }}>
                  ...
                  <>
                    <form onSubmit={handleEmailAuth} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <button type="submit" className="btn btn-primary"
                        style={{ width: '100%', justifyContent: 'center', height: '48px', marginTop: '4px' }}
                        disabled={loading}>
                    ...
                    <p style={{ textAlign: 'center', marginTop: '24px', fontFamily: 'var(--font-body)', fontSize: '13px', color: 'var(--neutral-500)' }}>
